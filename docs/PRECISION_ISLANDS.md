...
| Restart stiffness gather/scatter `MPI_DOUBLE` over `real_t *val` (:334/:421) | MPI | `FESOM_MPI_REAL`; **under SP the shadow (`dbl_t`) is what is written** ⇒ `MPI_DOUBLE` over `dbl_t` (Task B3b, divergence b) | |
