...
FIX = pathlib.Path("/work/ab0995/a270088/port/ice_fix_test")
FOR = pathlib.Path("/scratch/a/a270088/fortran_pp_2yr")  # 1958 ref (March)
...
fig.suptitle(f"ice_strength 0.5 restoration — March {YR} (same IC, 864r, dt1200, full ice)",fontsize=13)
fig.tight_layout(rect=[0,0,1,0.96]); fig.savefig(OUT/"ice_fix_ab.png",dpi=120,bbox_inches="tight")
print("wrote",OUT/"ice_fix_ab.png")
