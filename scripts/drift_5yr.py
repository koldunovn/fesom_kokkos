#!/usr/bin/env python3
"""5-year model-drift comparison: C port vs Fortran, IDENTICAL config (dt=1200,
...
C=pathlib.Path("/work/ab0995/a270088/port/c_5yr_dt1200")
F=pathlib.Path("/scratch/a/a270088/fortran_5yr_d1200")
DIAG=pathlib.Path("/scratch/a/a270088/fortran_pp_2yr/fesom.mesh.diag.nc")  # same mesh
OUT=pathlib.Path("/home/a/a270088/port2/fesom2_port/docs/drift_5yr"); OUT.mkdir(parents=True,exist_ok=True)
...
if n>0:
    ...
    fig.suptitle("5-yr drift: C vs Fortran (identical dt=1200/PP) — solid=value, dotted=C−F",fontsize=13)
