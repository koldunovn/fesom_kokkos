...
FIX = pathlib.Path("/work/ab0995/a270088/port/ice_fix_windrot_2yr")
...
rows=[]
for nm,d,suf in [("BUGGY (no fix)",BUG,".monthly"),("+0.5 +windrot",FIX,".monthly"),("Fortran PP",FOR,"")]:
    try:
...
panels=[("BUGGY (no fix)",BUG,".monthly"),("+0.5 +windrot",FIX,".monthly"),("Fortran PP",FOR,"")]
...
fig.tight_layout(rect=[0,0,1,0.96]); fig.savefig(OUT/"ice_fix_windrot_ab.png",dpi=120,bbox_inches="tight")
print("wrote",OUT/"ice_fix_windrot_ab.png")
