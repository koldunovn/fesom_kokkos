#!/usr/bin/env python3
"""2-year validation: C port (dt=1200, PP) vs Fortran reference (dt=1800, KPP).
...
F = pathlib.Path("/scratch/a/a270088/fortran_2yr_dt1800")
DIAG = F / "fesom.mesh.diag.nc"
SNAP = "/work/ab0995/a270088/port/dt1800_snap/snap_001340.nc"   # for elem_nodes
OUT = pathlib.Path("/home/a/a270088/port2/fesom2_port/docs/validation_dt1200")
...
for a,(c,f,ttl,u) in zip(ax.flat,[(cSST,fSST,"global-mean SST","degC"),
    ...
    a.plot(t,f,'-o',ms=3,label="Fortran (dt1800,KPP)",color="k")
...
fig.suptitle("2-year validation: C port (dt=1200, PP) vs Fortran (dt=1800, KPP)",fontsize=13)
