...
#SBATCH -o /work/ab0995/a270088/port2/m11/racepartgpu.%j.out
#SBATCH -e /work/ab0995/a270088/port2/m11/racepartgpu.%j.err
#
...
OUT=/work/ab0995/a270088/port2/m11/racepartgpu.${SLURM_JOB_ID}
mkdir -p "$OUT"
